...
App.Domain = {
  ...
  checkInit: function checkInit() {
    var buttons = document.getElementsByClassName('domain-check-btn');

    for (var i = 0; i < buttons.length; i++) {
      buttons[i].addEventListener('click', function (e) {
        var target = e.target;
        App.Ajax.post('/ajax/domain-checks', {
          domain_id: target.getAttribute('data-domain-id')
        }).then(function (response) {
          $.jGrowl("Success!");
          App.Domain.showChecks();
        })["catch"](function (error) {
          console.log(error.response);
          $.jGrowl("Error! " + error.response.status + " " + error.response.statusText, {
            theme: 'jgrowl-fail'
          });
        });
      });
...
window.jGrowl = __webpack_require__(/*! jgrowl */ "./node_modules/jgrowl/jquery.jgrowl.js");
...
__webpack_require__(/*! /home/pavel/php-project-lvl3/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/pavel/php-project-lvl3/resources/sass/app.sass */"./resources/sass/app.sass");
